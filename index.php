    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="logo.png" width="18%"> </a>
                    ...
                    <ul class="nav navbar-nav">
						...
						if(empty($_SESSION["user_id"])) // if user is not login
						...
						else
							{
                                    ...
                                    echo '<li class="nav-item"><a href="#" class="btn btn-primary btn-lg rounded-pill">Profile</a> </li>';
							}
    ...
    <section class="hero bg-image" data-image-src="images/img/back.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1><i>Delivery Deliciousness to Your Doorstep </i> 
            </h1>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                ...
                <p class="lead">Easiest way to order your favourite food among </p>
            </div>
            <div class="row">
